            ...
            <div className="max-w-lg w-full bg-white rounded-3xl shadow-2xl overflow-hidden border border-slate-100 z-10 animate-in fade-in zoom-in-95 duration-500">
                ...
                <div className="p-8 bg-slate-950 text-white text-center relative overflow-hidden border-b border-slate-900">
                    <div className="flex justify-center mb-4 relative z-10">
                        <div className="w-14 h-14 bg-gradient-to-tr from-green-900 to-green-600 rounded-2xl flex items-center justify-center shadow-lg shadow-green-900/40">
                    ...
                    <p className="text-slate-400 text-xs font-medium relative z-10 max-w-xs mx-auto">
                        {step === 1 && "Masukkan alamat email akun Sistem Informasi Desa Citali Anda untuk instruksi pemulihan."}
                    ...
                    {step === 1 && (
                        <form onSubmit={handleRequestOtp} className="space-y-5 animate-in fade-in duration-300">
                            ...
                            <button
                                ...
                                className="w-full py-4 bg-gradient-to-r from-green-900 to-green-700 hover:from-green-950 hover:to-green-800 text-white font-black rounded-xl text-xs uppercase tracking-widest shadow-lg shadow-green-950/20 active:scale-95 transition-all flex items-center justify-center gap-2 disabled:opacity-70"
                            >
                            ...
                            <div className="space-y-1.5">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-11 pr-4 py-3.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 outline-none focus:bg-white focus:border-green-700 transition-all font-mono font-bold text-base tracking-[0.6em] text-center"
                                        placeholder="••••••"
                                        value={otp}
                            ...
                            <div className="space-y-1.5">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-11 pr-11 py-3 bg-slate-50 border border-slate-200 rounded-xl text-xs font-bold text-slate-900 outline-none focus:bg-white focus:border-green-700 transition-all"
                                        placeholder="••••••••"
                                        value={newPassword}
