    ...
    return (
        <div className="space-y-6 max-w-6xl mx-auto font-sans animate-in fade-in duration-300">
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <div className="px-3 py-1.5 bg-green-50 text-green-800 border border-green-200 rounded-lg font-bold text-xs flex items-center gap-1.5">
                    <Layers size={14} /> DESA CITALI
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-1 space-y-6">
                    <div className="bg-white rounded-3xl shadow-sm border border-slate-200 p-8 text-center relative overflow-hidden flex flex-col justify-between">
                        {/* Ornamen Latar Hijau Gelap */}
                        <div className="absolute top-0 left-0 w-full h-32 bg-gradient-to-br from-slate-950 via-slate-900 to-green-950 rounded-t-3xl border-b border-slate-800"></div>
                        
                        <div className="relative z-10 flex flex-col items-center mt-6">
                            <div className="w-24 h-24 bg-gradient-to-tr from-green-800 to-green-500 rounded-full flex items-center justify-center shadow-xl shadow-green-900/20 border-4 border-white mb-4 text-white font-bold">
                                <UserIcon size={40} />
                            </div>
                            <h2 className="text-xl font-black text-slate-900 tracking-tight">{profileInfo?.name}</h2>
                            <p className="text-xs font-semibold text-green-700 mb-6">{profileInfo?.email}</p>
                            ...
                            <div className="w-full text-left space-y-4 border-t border-slate-100 pt-6">
                                <div>
                                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest flex items-center gap-1.5 mb-2">
                                        <ShieldCheck size={14} className="text-green-700" /> Grup Hak Akses
                                    </p>
                                ...
                                <div>
                                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest flex items-center gap-1.5 mb-2">
                                        <Globe size={14} className="text-green-700" /> Cakupan Otoritas
                                    </p>
                                    <div className="flex items-center gap-2 text-xs text-slate-700 bg-slate-50 p-3 rounded-xl border border-slate-150 font-bold">
                                        <Globe size={15} className="text-green-700 flex-shrink-0" /> Administrator Desa
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <form onSubmit={handleSubmit} className="bg-white rounded-3xl shadow-sm border border-slate-200 overflow-hidden flex flex-col justify-between">
                        ...
                        <div className="p-8 space-y-8 flex-1">
                            ...
                            <div className="space-y-5">
                                <h4 className="text-xs font-black text-slate-400 uppercase tracking-widest flex items-center gap-2 border-b border-slate-100 pb-2">
                                    <UserIcon size={14} className="text-green-700" /> Parameter Identitas
                                </h4>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    <div className="space-y-1.5 group">
                                        <label className="text-[10px] font-bold text-slate-500 uppercase tracking-wider block group-focus-within:text-green-700 transition-colors">Nama Lengkap Administrator</label>
                                        <input
                                            name="name" required value={formData.name} onChange={handleChange}
                                            className="w-full border border-slate-200 p-3.5 rounded-xl outline-none focus:ring-2 focus:ring-green-700/20 focus:border-green-700 transition-all font-bold text-xs text-slate-900 bg-slate-50/50 focus:bg-white"
                                        />
                                    </div>
                                    <div className="space-y-1.5 group">
                                        <label className="text-[10px] font-bold text-slate-500 uppercase tracking-wider block group-focus-within:text-green-700 transition-colors">Surel Korespondensi</label>
                                        <div className="relative">
                                            <Mail className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-green-700 transition-colors" size={18} />
                                            <input
                                                name="email" type="email" required value={formData.email} onChange={handleChange}
                                                className="w-full pl-11 pr-4 border border-slate-200 p-3.5 rounded-xl outline-none focus:ring-2 focus:ring-green-700/20 focus:border-green-700 transition-all font-bold text-xs text-slate-900 bg-slate-50/50 focus:bg-white"
                                            />
                                        </div>
                                        {formData.email !== profileInfo?.email && (
                                            <p className="text-[10px] text-green-700 font-bold mt-1">* Autentikasi token OTP akan ditransmisikan ke surel baru.</p>
                                        )}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-5 pt-4">
                                <h4 className="text-xs font-black text-slate-400 uppercase tracking-widest flex items-center gap-2 border-b border-slate-100 pb-2">
                                    <KeyRound size={14} className="text-green-700" /> Kata Sandi Otorisasi (Opsional)
                                </h4>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    <div className="space-y-1.5 group md:col-span-2">
                                        <label className="text-[10px] font-bold text-slate-500 uppercase tracking-wider block group-focus-within:text-green-700 transition-colors">Kata Sandi Saat Ini</label>
                                        <div className="relative">
                                            <Lock className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-green-700 transition-colors" size={18} />
                                            <input
                                                name="oldPassword" type={showPasswords.old ? "text" : "password"} value={formData.oldPassword} onChange={handleChange}
                                                className="w-full pl-11 pr-12 border border-slate-200 p-3.5 rounded-xl outline-none focus:ring-2 focus:ring-green-700/20 focus:border-green-700 transition-all font-bold text-xs text-slate-900 bg-slate-50/50 focus:bg-white placeholder:font-normal"
                                    ...
                                    <div className="space-y-1.5 group">
                                        <label className="text-[10px] font-bold text-slate-500 uppercase tracking-wider block group-focus-within:text-green-700 transition-colors">Kata Sandi Baru</label>
                                        <div className="relative">
                                            <Lock className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-green-700 transition-colors" size={18} />
                                            <input
                                    ...
                                    <div className="space-y-1.5 group">
                                        <label className="text-[10px] font-bold text-slate-500 uppercase tracking-wider block group-focus-within:text-green-700 transition-colors">Konfirmasi Kata Sandi</label>
                                        <div className="relative">
                                            <Lock className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-green-700 transition-colors" size={18} />
                                            <input
                        ...
                        <div className="p-6 bg-slate-50/50 border-t border-slate-100 flex justify-end">
                            <button
                                ...
                                className="bg-gradient-to-r from-green-800 to-green-600 text-white px-8 py-3.5 rounded-xl font-black text-xs uppercase tracking-widest shadow-lg shadow-green-950/20 hover:from-green-900 hover:to-green-700 transition-all active:scale-95 flex items-center justify-center gap-2 disabled:opacity-70 cursor-pointer"
                            >
                    ...
                    <div className="bg-white rounded-3xl w-full max-w-sm shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200 border border-slate-100">
                        ...
                        <form onSubmit={handleVerifyOtpSubmit} className="p-7 space-y-5">
                            <p className="text-xs text-slate-500 text-center font-medium leading-relaxed max-w-xs mx-auto">
                                ...
                                <strong className="text-green-700 block mt-1">{formData.email}</strong>
                            </p>
                            <div className="space-y-1.5 group">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-11 pr-4 py-3.5 border border-slate-200 rounded-xl outline-none focus:border-green-700 font-mono font-bold text-center text-lg tracking-[0.6em] text-slate-900 bg-slate-50/50"
                                        placeholder="••••••"
                                    />
                                </div>
                            </div>
            ...
            {isSuccessModalOpen && (
                <div className="fixed inset-0 z-[80] flex items-center justify-center bg-slate-950/70 backdrop-blur-md p-4">
                    <div className="bg-white rounded-3xl w-full max-w-sm shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200 border border-slate-100 text-center p-8">
                        <div className="w-16 h-16 bg-green-50 text-green-700 rounded-full flex items-center justify-center mx-auto mb-4 border border-green-100">
                            <CheckCircle size={32} />
                        </div>
